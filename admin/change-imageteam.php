...
move_uploaded_file($_FILES["profilepic"]["tmp_name"],"profilepics/".$imgnewfile);
  // Query for data insertion
     $query=mysqli_query($con, "update teams set ProfilePic='$imgnewfile' where id='$uid' ");
    if ($query) {
    	//Old pic
    	unlink($oldprofilepic);
    echo "<script>alert('Profile pic updated successfully');</script>";
    echo "<script type='text/javascript'> document.location ='indexteams.php'; </script>";
  }
  else
    {
...
<div class="signup-form">
 ...
 <?php
$eid=$_GET['userid'];
$ret=mysqli_query($con,"select * from teams where id='$eid'");
