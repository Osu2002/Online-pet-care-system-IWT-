			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form action="contactviewform.php" id="contact_form" class="contact_form text-center" method="post">
							<input type="text"  class="contact_form_name input_field" name="name" placeholder="Name" required="required" data-error="Name is required." value="<?php  echo $row['username'];?>">
							<input type="text" class="contact_form_email input_field" name="email" placeholder="E-mail" required="required" data-error="Email is required." value="<?php  echo $row['email'];?>">
							<input type="text" class="contact_form_subject input_field" name="subject" placeholder="Subject" required="required" data-error="Subject is required." value="<?php  echo $row['subject'];?>">
							<textarea class="text_field contact_form_message" name="message" rows="4" placeholder="Message" required="required" data-error="Please, write us a message." value="<?php  echo $row['massage'];?>"></textarea>
