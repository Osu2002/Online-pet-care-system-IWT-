		...
		<div class="row">
			<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
				<div class="logo_container">
					<div class="logo"><img src="img/logo.png" alt="Tail waggers"></div>
				</div> 
				<div class="main_nav_container ml-auto">
					<ul class="main_nav_list">
						...
						<li class="main_nav_item"><a href="login.php" id="login">login & signup</a></li>
					</ul>
				</div>
				<div >
...
<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
	...
	<div class="logo menu_logo"><img src="img/logo.png" alt=""></div>
	<ul>
		...
		<li class="menu_item"><a href="login.php">login & signup</a></li>
	</ul>
</div>
</div>
